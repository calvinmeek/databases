<?php
	...
	$rating5 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (11,'10-2-18',5,2,5,'',2)");
	$rating6 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (14,'05-2-18',1,3,2,'',3)");
	$rating7 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (12,'08-2-18',2,1,1,'',2)");
	$rating8 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (13,'09-5-11',3,4,2,'',4)");
	$rating9 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (14,'06-6-18',4,2,4,'',5)");
	$rating10 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (3,'04-6-18',3,1,4,'',11)");
	$rating11 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (5,'03-10-18',2,5,2,'',11)");
	$rating12 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (3,'01-11-14',1,2,5,'',12)");
	$rating13 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (6,'02-14-15',1,4,3,'',7)");
	$rating14 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (7,'03-01-18',3,1,5,'',5)");
	$rating15 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (8,'05-13-18',4,3,5,'',7)");
	$rating16 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (9,'05-10-48',4,3,4,'',7)");
	$rating17 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (10,'05-19-18',4,3,2,'',7)");
	...
	$rating19 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (11,'12-16-12',2,3,5,'',2)");
	...
	$rating23 = pg_query($conn, "INSERT INTO rating(id,rating_date,price,food,mood,commments,restaurantID) VALUES (4,'12-06-18',3,3,5,'',9)");
