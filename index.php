<?php
	...
	$queryL = pg_query($conn, "SELECT R.usrName, R.rep, Rst.name, Rt.rating_date FROM rater R, rating Rt, restaurant Rst WHERE R.id = Rt.id GROUP BY Rst.name, R.usrName, R.rep, Rt.rating_date, Rt.food, Rt.mood HAVING Rt.food + Rt.mood > 3");
