<?php
	...
	$sql = "CREATE TABLE rater ( INT(4) UNSIGNED AUTO_INCREMENT PRIMARY KEY, fname VARCHAR(15) NOT NULL, lname VARCHAR(20) NOT NULL, email VARCHAR(30) NOT NULL, joinDate DATE, type VARCHAR(15), rep INT(4)";
