<?php
	...
	$queryB = pg_query($conn, "SELECT menuItem.id, name FROM menuItem, restaurant WHERE menuItem.restaurantID = restaurant.restaurantID AND restaurant.name = '$testString'");
