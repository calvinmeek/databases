<?php
	...
	$queryJ = pg_query($conn, "SELECT R.name, R.restaurantID, Rt.price, Rt.food, Rt.mood, Rt.staff FROM restaurant R, rating Rt GROUP BY R.restaurantID, R.name HAVING Rt.price + Rt.food + Rt.mood + Rt.staff > 20");
